...
-   Rammprasad Ganapathy (Ram)
    -   Principal Data Scientist with over 15 years of experience in EDC and Statistical 
        Programming.
    -   Based in San Francisco Bay area in CA.
    -   Passionate about developing R packages, creating innovative solutions, and automation.
    -   Led the team and the {roak} product from Vision → PoC → Production. It is now utilized in more than 50 studies at Roche for regulatory reporting.
...
-   Shiyu Chen
    -   R programmer with 5 years of experience in Statistical Programming and Package Development.
...
::: incremental
{sdtm.oak} algorithms enhance {dplyr}, allowing users to perform multiple actions within a single function call. These capabilities include:

-  Applying Controlled Terminology, providing a simple approach compared to case_when statements.
...
-  Applying conditions during mapping within a single function call.

While these tasks can be achieved using {dplyr} alone, {sdtm.oak} offers a more elegant and efficient solution.
:::
